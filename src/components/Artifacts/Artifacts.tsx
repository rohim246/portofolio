...
import { projects, categories, artifactsSectionData } from "./artifacts.data";
    ...
    <SectionWrapper id="artifacts">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          >
            {artifactsSectionData.description}
          </motion.p>
        </div>
